    ...
    <div class="w-full max-w-4xl mx-auto my-20">
        <section class="space-y-6">
            ...
            <div class="flex items-center justify-between mb-4 bg-white py-2 px-4 rounded">
                <a href="{{ route('admin.attendance.show', [$user->id, 'month' => $previousMonth]) }}" class="text-gray-600 hover:underline">&lt 前月</a>
                ...
                <a href="{{ route('admin.attendance.show', [$user->id, 'month' => $nextMonth]) }}" class="text-gray-600 hover:underline">翌月 &gt</a>
            </div>
